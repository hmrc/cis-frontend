...
enum SubcontractorType(val value: String) extends WithName(value) {
  case SoleTrader extends SubcontractorType("soletrader")
  case Company extends SubcontractorType("company")
  case Partnership extends SubcontractorType("partnership")
  case Trust extends SubcontractorType("trust")
}
