...
echo "$domain$.$className;format="decap"$.title = $title$" >> ../conf/messages.en
echo "$domain$.$className;format="decap"$.heading = $title$" >> ../conf/messages.en
echo "$domain$.$className;format="decap"$.$option1key;format="decap"$ = $option1msg$" >> ../conf/messages.en
echo "$domain$.$className;format="decap"$.$option2key;format="decap"$ = $option2msg$" >> ../conf/messages.en
echo "$domain$.$className;format="decap"$.checkYourAnswersLabel = $title$" >> ../conf/messages.en
echo "$domain$.$className;format="decap"$.error.required = Select $className;format="decap"$" >> ../conf/messages.en
