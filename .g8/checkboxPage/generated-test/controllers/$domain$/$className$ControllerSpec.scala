...
import forms.$domain$.$className$FormProvider
import models.{NormalMode, $domain$.$className$, UserAnswers}
...
import views.html.$domain$.$className$View
...
class $className$ControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val $className;format="decap"$Route = routes.$domain$.$className$Controller.onPageLoad(NormalMode).url
