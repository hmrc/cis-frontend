...
echo "Adding messages to conf/messages.en"
...
echo "$domain$.$className;format="decap"$.error.required = Select Yes or No" >> ../conf/messages.en
echo "$domain$.$className;format="decap"$.change.hidden = change $className;format="decap"$" >> ../conf/messages.en
