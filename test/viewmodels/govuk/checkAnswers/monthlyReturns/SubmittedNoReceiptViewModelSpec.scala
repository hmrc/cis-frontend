...
class SubmittedNoReceiptViewModelSpec extends AnyWordSpec with Matchers {
  "SubmittedNoReceiptViewModel" should {
    "create successfully" in {
      val vm = SubmittedNoReceiptViewModel(
      ...
      vm.periodEnd mustBe "January 2025"
      vm.submissionType mustBe ReturnType.MonthlyNilReturn
