...
class TaxMonthPeriodsTableSpec extends SpecBase with Matchers {
  ...
  "TaxMonthPeriodsTable" - {
    ...
    "must render all months in correct order" in new Setup {
      ...
      val expectedMonths = Seq("May", "June", "July", "August", "September", "October", 
    ...
    "must render all input values in correct order" in new Setup {
      ...
      val expectedInputs = Seq("05 2025", "06 2025", "07 2025", "08 2025", "09 2025", "10 2025",
                              "11 2025", "12 2025", "01 2025", "02 2025", "03 2025", "04 2025")
    ...
    "must render all period ranges in correct order" in new Setup {
      ...
      val expectedPeriods = Seq(
        "6th April - 5th May", "6th May - 5th June", "6th June - 5th July", "6th July - 5th August",
        "6th August - 5th September", "6th September - 5th October", "6th October - 5th November",
        "6th November - 5th December", "6th December - 5th January", "6th January - 5th February",
        "6th February - 5th March", "6th March - 5th April"
      )
