...
class FirstMiddleNameSpec extends SpecBase {

  import FirstMiddleName.isValid
  import FirstMiddleName.isLengthInRange

  "The FirstMiddleName utility object" - {
